...
function shell(content: string, title: string, description: string) {
  ...
  return `
    ...
    <footer><div><a class="wordmark route-link" href="/">Spoken Dev Brief</a><p>Confirmed engineering decisions from spoken work.</p></div><div class="footer-links"><a class="route-link" href="/privacy">Privacy</a><a class="route-link" href="/terms">Terms</a><a href="https://hello-factory.sociobot.in" rel="noreferrer">Built by Param Factory <span class="sr-only">(external)</span></a><span>v0.1.4</span></div><p class="generated-note">Poster artwork was generated for this product.</p></footer>`;
}
